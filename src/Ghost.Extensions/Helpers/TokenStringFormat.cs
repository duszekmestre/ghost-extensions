            ...
            if (values != null)
            {
                foreach (PropertyDescriptor propertyDescriptor in TypeDescriptor.GetProperties(values))
                {
                    ...
                    if (dict != null)
                    {
                        ...
                        {
                            valueDictionary.Add(string.Format("{0}[\"{1}\"]", propertyDescriptor.Name, dictKeyValue.GetPropertyValue("Key")), dictKeyValue.GetPropertyValue("Value"));
                        }
                    }
                    else
                    {
                        valueDictionary.Add(propertyDescriptor.Name, value);
                    }
                }
            }
